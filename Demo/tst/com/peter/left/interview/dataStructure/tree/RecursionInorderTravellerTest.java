...
public class RecursionInorderTravellerTest
{
    ...
    public void setUp()
    {
        traveller = new RecursionInorderTraveller<>();
    ...
    public void travelRootOnlyHasBothChild_itShould_returnSingletonList()
    {
        ...
        assertThat(travelResult, equalTo(Lists.newArrayList(left, obj,right)));
    }
    ...
    public void travelMultipleLevelTree_itShould_returnSingletonList()
    {
        ...
        assertThat(travelResult, equalTo(Lists.newArrayList(
                leftleft, left, leftright, obj, rightleft, right, rightright)));
    }
}
