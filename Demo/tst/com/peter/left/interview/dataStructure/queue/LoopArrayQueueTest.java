...
public class LoopArrayQueueTest
{
    ...
    private void emptyQueue(final Queue<Object> queue)
    {
        while (!queue.isEmpty())
        {
            queue.dequeue();
    ...
    public void setUp()
    {
        queue = new LoopArrayQueue<>(objs.length);
    }
    ...
    @Test
    public void enqueueToFullElements_itShould_fail()
    {
        fillQueue(queue, objs);
    ...
    @Test
    public void multipleEnqueueMultipleDequeueHeadAtMiddle_itShould_getExpectedQueue()
    {
        final Object[] destObjs = Arrays.copyOf(objs, objs.length - 1);
        fillQueue(queue, destObjs);
        emptyQueue(queue);
    ...
    @Test
    public void multipleEnqueueMultipleDequeueHeadAtEnd_itShould_getExpectedQueue()
    {
        fillQueue(queue, objs);
        emptyQueue(queue);
    ...
    @Test
    public void queueIteratorHeadAtEnd_itShould_actAsExpected()
    {
        fillQueue(queue, objs);
        emptyQueue(queue);
    ...
    @Test
    public void queueIteratorHeadAtMiddle_itShould_actAsExpected()
    {
        final Object[] destObjs = Arrays.copyOf(objs, objs.length - 1);
        fillQueue(queue, destObjs);
        emptyQueue(queue);
